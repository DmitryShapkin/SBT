...
- (void)setupLayout {
    ...
    self.coverImageView.frame = CGRectMake(self.offset, self.offset, self.coverImageSide, self.coverImageSide);
    
    self.boxView.frame = CGRectMake(CGRectGetMaxX(self.coverImageView.frame) + self.offset, CGRectGetMinY(self.coverImageView.frame), CGRectGetWidth(self.frame) - CGRectGetWidth(self.coverImageView.frame) - self.offset * 3, CGRectGetHeight(self.coverImageView.frame));
